...
```javascript
import noneByRight from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-none-by-right@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/utils-none-by-right/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/utils-none-by-right/actions/workflows/test.yml?query=branch:v0.2.1
